<template>
  <view :class="[prefixCls]" :style="[tabStyle]">
    <view :id="id">
      <scroll-view
        scroll-x
      ...
      >
        <view :class="[`${prefixCls}-box`, !isScroll && `${prefixCls}-flex`]">
          <view
...
<script>
/*
 * @fileoverview | tabs标签组件
 * @version 0.2 | 2021-10-15 10:43:12
 * @Last Modified by: halld
 * @Last Modified 2021-10-15 10:43:12
 */
 ...
 * @example <tm-tabs ref="tabs" :list="list" :is-scroll="false"></tm-tabs>
 */
export default {
  name: 'TTabs',
  props: {
